// ============================================================
//  oefeningen/oe_6.js  —  Drag and drop verzamelingen
// ============================================================
...
window.__taakOefening = (function () {
  ...
  function _bouwOefening() {
    const inhoud = maakOefening({ id: 'oe_6', nummer: 6, container: _container });
    ...
    if (!_blokkeren) {
      [bank, ...veldEls].forEach(zone => {
        ...
        zone.addEventListener('drop', e => {
          ...
          // Antwoord opslaan per veld
          ITEMS.forEach(item => {
            const v = _plaatsing[item.id];
            _antwoorden[item.veld].antwoord = (v === item.veld) ? item.id : (v !== null && v !== undefined ? item.id : null);
          });
        });
      });
    }
  ...
  function getAntwoorden() {
    ITEMS.forEach(item => {
      ...
      _antwoorden[item.veld].antwoord = (veld !== null && veld !== undefined) ? item.id : null;
    });
    return [..._antwoorden];
  }
