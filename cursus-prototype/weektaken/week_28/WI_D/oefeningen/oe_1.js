// ============================================================
//  oefeningen/oe_1.js  —  Flashcards eigenschappen (deel 1)
//
//  Pas aan per deel:
...
window.__taakOefening = (function () {
  ...
  const TOON_ITEM     = 'woorden';   // zichtbaar op flashcard
  const CONTROLE_ITEM = 'symbolen';  // zichtbaar na controle
  ...
  function _bouwOefening() {
    ...
    voegTekstToe(inhoud, 'Van woorden naar symbolen', ['intro-tekst']);
    voegLijstToe(inhoud, 'bullet', '0cm', '0.3cm', [
      'Je krijgt op de flashcard de eigenschap in woorden te zien.',
      'Noteer op een kladblad de eigenschap in symbolen.',
      'Klik daarna op controle en check wat je opgeschreven hebt.',
      'Kies daarna uit \'Ken ik!\' of \'Ken ik nog niet.\'.',
      'Herhaal totdat je alle eigenschappen geoefend hebt.',
      '<span class="markeer-lila">Let op! Straks moet je een foto van je kladblad uploaden.</span>',
    ]);  
