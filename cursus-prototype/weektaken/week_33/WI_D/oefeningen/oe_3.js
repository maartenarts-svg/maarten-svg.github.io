// ============================================================
//  oefeningen/oe_3.js  —  Vergelijking: -7y = 77
// ============================================================

window.__taakOefening = (function () {

  const CORRECT_TS_L  = '-7y:(-7)';
  const CORRECT_TS_R  = '77:(-7)';
  const CORRECT_ANT_L = 'y';
  const CORRECT_ANT_R = '-11';
  ...
  function render(container, opgeslagenAntwoorden, verbeterd) {
    ...
    opgRij.innerHTML = '<span style="font-weight:bold;">−7<em>y</em> = 77</span>';
    ...
    if (verbeterd) {
      ...
      if (oefJuist) {
        ...
        `;
        uitw.innerHTML =
          '<div>−7<em>y</em> = 77</div>' +
          '<div style="font-family:Arial,sans-serif;font-style:italic;color:var(--tekst,#1a1a1a);">Je moet in het linkerlid de factor −7 wegwerken, dus je moet beide leden delen door −7.</div>' +
          '<div>−7<em>y</em> : (−7) = 77 : (−7)</div>' +
          '<div><em>y</em> = −11</div>';
        fb.appendChild(uitw);
      }
