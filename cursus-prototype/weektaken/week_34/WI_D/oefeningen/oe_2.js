...
window.__taakOefening = (function () {
  ...
  const BLOKJES = [
    { nr: 1, pad: '../../../hoofdstukken/H11/H11_W34WID/oe_1.js' },
    { nr: 2, pad: '../../../hoofdstukken/H11/H11_W34WID/oe_2.js' },
    { nr: 3, pad: '../../../hoofdstukken/H11/H11_W34WID/oe_3.js' },
  ];
  ...
  function _openViewer(blokje, idx) {
    const url = new URL('../../week_34/WI_D/correctiesleutel-viewer-taak.html', window.location.href);
