...
window.__taakOefening = (function () {
  ...
  const BLOKJES = [
    { nr: 1, pad: '../../../hoofdstukken/H10/P10_toets/oe_10T005.js' },
    { nr: 2, pad: '../../../hoofdstukken/H10/P10_toets/oe_10T006.js' },
    { nr: 3, pad: '../../../hoofdstukken/H10/P10_toets/oe_10T007.js' },
  ...
  function render(container, opgeslagenAntwoorden, verbeterd, mail, slaOp, leerling, herlaadLeerling) {
    if (opgeslagenAntwoorden && Array.isArray(opgeslagenAntwoorden)) {
      ...
      while (_antwoorden.length < 7) _antwoorden.push({ antwoord: null, score: 0 });
    }
  ...
  function _openViewer(blokje, idx) {
    const url = new URL('../../week_32/WI_E/correctiesleutel-viewer-taak.html', window.location.href);
