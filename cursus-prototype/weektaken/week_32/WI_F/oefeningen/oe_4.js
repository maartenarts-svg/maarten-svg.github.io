// ============================================================
//  oefeningen/oe_4.js  —  Coördinaat aflezen: punt C
// ============================================================
window.__taakOefening = (function () {
  ...
  function _bouw(container) {
    const inhoud = maakOefening({ id: OEF_ID, nummer: 4, container });
  ...
  <defs>
    <marker id="px4" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#1a1a1a"/></marker>
    <marker id="py4" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#1a1a1a"/></marker>
  </defs>
  ...
  ${rooster}
  <line class="as" x1="14" y1="260" x2="510" y2="260" marker-end="url(#px4)"/>
  <line class="as" x1="260" y1="506" x2="260" y2="10" marker-end="url(#py4)"/>
  ${ms}${gt}
