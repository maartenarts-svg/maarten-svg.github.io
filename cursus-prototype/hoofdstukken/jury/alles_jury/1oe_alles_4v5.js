/* ============================================================
   alles_jury / oe_alles_4v5.js
   soort: test
   ============================================================ */
(function () {

  const opgave = document.createElement('span');
  opgave.appendChild(htmlSpan('-5<i>z</i> + 4 = -<i>z</i> - 12'));

  const stap2 = document.createElement('span');
  stap2.appendChild(htmlSpan('-5<i>z</i> <span class="markeer-lila">+ <i>z</i></span> = -12 <span class="markeer-lila">- 4</span>'));

  const stap3 = document.createElement('span');
  stap3.appendChild(htmlSpan('-4<i>z</i> = -16'));

  const stap4 = document.createElement('span');
  stap4.appendChild(htmlSpan('<i>z</i> = -16 <span class="markeer-lila">: (-4)</span>'));
  ...
  ll.appendChild(htmlSpan('-5 · <span class="markeer-lila">4</span> + 4 = -20 + 4 = -16'));

  const rl = document.createElement('span');
  const rl_b1 = maakSpanBreedte('0.65cm', 'RL:');
  rl.appendChild(rl_b1);
  rl.appendChild(htmlSpan('-<span class="markeer-lila">4</span> - 12 = -16'));

  const inhoud = maakOefening({
    id:'oe_alles_4v5', nummer:'4', soort:'test',
    niveaus:[], tools:[],
