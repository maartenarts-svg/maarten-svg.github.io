...
(function () {
  ...
  macht5.appendChild(htmlSpan('(-1)<sup>5</sup>'));

  const macht6 = document.createElement('span');
  macht6.appendChild(htmlSpan('= -1 · (-1) · (-1) · (-1) · (-1)'));
