...
(function () {
  ...
  macht5.appendChild(htmlSpan('(-2)<sup>6</sup>'));

  const macht6 = document.createElement('span');
  macht6.appendChild(htmlSpan('= -2 · (-2) · (-2) · (-2) · (-2) · (-2)'));
