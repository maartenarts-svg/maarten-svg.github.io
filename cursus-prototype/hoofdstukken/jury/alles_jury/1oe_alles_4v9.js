/* ============================================================
   alles_jury / oe_alles_4v9.js
   soort: test
   ============================================================ */
(function () {

  const opgave = document.createElement('span');
  opgave.appendChild(htmlSpan('9<i>z</i> + 13 = 4<i>z</i> - 7'));

  const stap2 = document.createElement('span');
  stap2.appendChild(htmlSpan('9<i>z</i> <span class="markeer-lila">- 4<i>z</i></span> = -7 <span class="markeer-lila">- 13</span>'));

  const stap3 = document.createElement('span');
  stap3.appendChild(htmlSpan('5<i>z</i> = -20'));

  const stap4 = document.createElement('span');
  stap4.appendChild(htmlSpan('<i>z</i> = -20 <span class="markeer-lila">: 5</span>'));

  const stap5 = document.createElement('span');
  stap5.appendChild(htmlSpan('<i>z</i> = -4'));
  ...
  ll.appendChild(htmlSpan('9 · <span class="markeer-lila">(-4)</span> + 13 = -36 + 13 = -23'));

  const rl = document.createElement('span');
  const rl_b1 = maakSpanBreedte('0.65cm', 'RL:');
  rl.appendChild(rl_b1);
  rl.appendChild(htmlSpan('4 · <span class="markeer-lila">(-4)</span> - 7 = -16 - 7 = -23'));

  const inhoud = maakOefening({
    id:'oe_alles_4v9', nummer:'4', soort:'test',
    niveaus:[], tools:[],
