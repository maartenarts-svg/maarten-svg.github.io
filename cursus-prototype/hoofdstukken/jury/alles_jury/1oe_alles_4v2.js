/* ============================================================
   alles_jury / oe_alles_4v2.js
   soort: test
   ============================================================ */
(function () {

  const opgave = document.createElement('span');
  opgave.appendChild(htmlSpan('9<i>t</i> + 8 = 6<i>t</i> - 7'));

  const stap2 = document.createElement('span');
  stap2.appendChild(htmlSpan('9<i>t</i> <span class="markeer-lila">- 6<i>t</i></span> = -7 <span class="markeer-lila">- 8</span>'));

  const stap3 = document.createElement('span');
  stap3.appendChild(htmlSpan('3<i>t</i> = -15'));

  const stap4 = document.createElement('span');
  stap4.appendChild(htmlSpan('<i>t</i> = -15 <span class="markeer-lila">: 3</span>'));
  ...
  ll.appendChild(htmlSpan('9 · <span class="markeer-lila">(-5)</span> + 8 = -45 + 8 = -37'));

  const rl = document.createElement('span');
  const rl_b1 = maakSpanBreedte('0.65cm', 'RL:');
  rl.appendChild(rl_b1);
  rl.appendChild(htmlSpan('6 · <span class="markeer-lila">(-5)</span> - 7 = -30 - 7 = -37'));

  const inhoud = maakOefening({
    id:'oe_alles_4v2', nummer:'4', soort:'test',
    niveaus:[], tools:[],
