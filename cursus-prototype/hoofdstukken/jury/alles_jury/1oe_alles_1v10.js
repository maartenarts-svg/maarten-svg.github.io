/* ============================================================
   alles_jury / oe_alles_1v10.js
   soort: test
   ============================================================ */
(function () {

  const a1 = document.createElement('span');
  a1.appendChild(maakBreuk('5','6','opgave'));
  a1.appendChild(htmlSpan(' - '));
  a1.appendChild(maakBreuk('-2','5','opgave'));

  const a2 = document.createElement('span');
  a2.appendChild(htmlSpan('= '));
  a2.appendChild(maakBreuk('5','6','opgave'));
  a2.appendChild(htmlSpan(' + '));
  a2.appendChild(maakBreuk('2','5','opgave'));

  const a3 = document.createElement('span');
  a3.appendChild(htmlSpan('= '));
  a3.appendChild(maakBreuk('25','30','opgave'));
  a3.appendChild(htmlSpan(' + '));
  a3.appendChild(maakBreuk('12','30','opgave'));

  const a4 = document.createElement('span');
  a4.appendChild(htmlSpan('= '));
  a4.appendChild(maakBreuk('25 + 12','\u200A \u200A \u200A 30\u200A \u200A \u200A ','opgave'));

  const a5 = document.createElement('span');
  a5.appendChild(htmlSpan('= '));
  a5.appendChild(maakBreuk('37','30','opgave'));

  const b1 = document.createElement('span');
  b1.appendChild(maakBreuk('-5','3','opgave'));
  b1.appendChild(htmlSpan(' : '));
  b1.appendChild(maakBreuk('-4','7','opgave'));

  const b2 = document.createElement('span');
  b2.appendChild(htmlSpan('= '));
  b2.appendChild(maakBreuk('-5','3','opgave'));
  b2.appendChild(htmlSpan(' · '));
  b2.appendChild(maakBreuk('-7','4','opgave'));

  const b3 = document.createElement('span');
  b3.appendChild(htmlSpan('= '));
  b3.appendChild(maakBreuk('5 · 7','3 · 4','opgave'));

  const b4 = document.createElement('span');
  b4.appendChild(htmlSpan('= '));
  b4.appendChild(maakBreuk('35','12','opgave'));

  const inhoud = maakOefening({
    id:'oe_alles_1v10', nummer:'1', soort:'test',
    niveaus:[], tools:[],
