...
(function () {
  ...
  macht2.appendChild(htmlSpan('7<sup>2</sup>'));

  const macht3 = document.createElement('span');
  macht3.appendChild(htmlSpan('= 7 · 7'));

  const macht4 = document.createElement('span');
  macht4.appendChild(htmlSpan('= 49'));

  const macht5 = document.createElement('span');
  macht5.appendChild(htmlSpan('(-6)<sup>3</sup>'));

  const macht6 = document.createElement('span');
  macht6.appendChild(htmlSpan('= -6 · (-6) · (-6)'));

  const macht7 = document.createElement('span');
  macht7.appendChild(htmlSpan('= -216'));
