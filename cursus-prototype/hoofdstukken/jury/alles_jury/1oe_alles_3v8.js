...
(function () {
  ...
  antwoordA.appendChild(htmlSpan('-5 + 6<i>x</i>'));

  const opgaveB = document.createElement('span');
  opgaveB.appendChild(htmlSpan('-5(2<i>y</i> - 3)'));

  const antwoordB = document.createElement('span');
  antwoordB.appendChild(htmlSpan('-10<i>y</i> + 15'));

  const inhoud = maakOefening({
    id:'oe_alles_3v8', nummer:'3', soort:'test',
    niveaus:[], tools:[],
