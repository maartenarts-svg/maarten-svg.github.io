...
(function () {
  ...
  macht2.appendChild(htmlSpan('2<sup>4</sup>'));

  const macht3 = document.createElement('span');
  macht3.appendChild(htmlSpan('= 2 · 2 · 2 · 2'));

  const macht4 = document.createElement('span');
  macht4.appendChild(htmlSpan('= 16'));

  const macht5 = document.createElement('span');
  macht5.appendChild(htmlSpan('(-10)<sup>5</sup>'));

  const macht6 = document.createElement('span');
  macht6.appendChild(htmlSpan('= -10 · (-10) · (-10) · (-10) · (-10)'));

  const macht7 = document.createElement('span');
  macht7.appendChild(htmlSpan('= -100 000'));
