...
(function () {
  ...
  macht2.appendChild(htmlSpan('3<sup>4</sup>'));

  const macht3 = document.createElement('span');
  macht3.appendChild(htmlSpan('= 3 · 3 · 3 · 3'));

  const macht4 = document.createElement('span');
  macht4.appendChild(htmlSpan('= 81'));

  const macht5 = document.createElement('span');
  macht5.appendChild(htmlSpan('(-4)<sup>3</sup>'));

  const macht6 = document.createElement('span');
  macht6.appendChild(htmlSpan('= -4 · (-4) · (-4)'));

  const macht7 = document.createElement('span');
  macht7.appendChild(htmlSpan('= -64'));
