/* ============================================================
   alles_jury / oe_alles_4v3.js
   soort: test
   ============================================================ */
(function () {

  const opgave = document.createElement('span');
  opgave.appendChild(htmlSpan('11<i>z</i> + 8 = -12 + <i>z</i>'));

  const stap2 = document.createElement('span');
  stap2.appendChild(htmlSpan('11<i>z</i> <span class="markeer-lila">- <i>z</i></span> = -12 <span class="markeer-lila">- 8</span>'));

  const stap3 = document.createElement('span');
  stap3.appendChild(htmlSpan('10<i>z</i> = -20'));

  const stap4 = document.createElement('span');
  stap4.appendChild(htmlSpan('<i>z</i> = -20 <span class="markeer-lila">: 10</span>'));

  const stap5 = document.createElement('span');
  stap5.appendChild(htmlSpan('<i>z</i> = -2'));
  ...
  ll.appendChild(htmlSpan('11 · <span class="markeer-lila">(-2)</span> + 8 = -22 + 8 = -14'));

  const rl = document.createElement('span');
  const rl_b1 = maakSpanBreedte('0.65cm', 'RL:');
  rl.appendChild(rl_b1);
  rl.appendChild(htmlSpan('-12 + <span class="markeer-lila">(-2)</span> = -14'));

  const inhoud = maakOefening({
    id:'oe_alles_4v3', nummer:'4', soort:'test',
    niveaus:[], tools:[],
