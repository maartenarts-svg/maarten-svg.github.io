/* ============================================================
   alles_jury / oe_alles_3v7.js
   soort: test
   ============================================================ */
(function () {

  const opgaveA = document.createElement('span');
  opgaveA.appendChild(maakOnderstreping(htmlSpan('-4<i>a</i>'), 'dubbel', '0.18cm', true));
  ...
  antwoordA.appendChild(htmlSpan('1 - 5<i>a</i>'));

  const opgaveB = document.createElement('span');
  opgaveB.appendChild(htmlSpan('-4(-1 - 2<i>b</i>)'));

  const antwoordB = document.createElement('span');
  antwoordB.appendChild(htmlSpan('4 + 8<i>b</i>'));

  const inhoud = maakOefening({
    id:'oe_alles_3v7', nummer:'3', soort:'test',
    niveaus:[], tools:[],
