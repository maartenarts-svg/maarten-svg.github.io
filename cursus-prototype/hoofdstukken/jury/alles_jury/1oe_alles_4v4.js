/* ============================================================
   alles_jury / oe_alles_4v4.js
   soort: test
   ============================================================ */
(function () {

  const opgave = document.createElement('span');
  opgave.appendChild(htmlSpan('-2<i>t</i> - 5 = -15 + 3<i>t</i>'));

  const stap2 = document.createElement('span');
  stap2.appendChild(htmlSpan('-2<i>t</i> <span class="markeer-lila">- 3<i>t</i></span> = -15 <span class="markeer-lila">+ 5</span>'));

  const stap3 = document.createElement('span');
  stap3.appendChild(htmlSpan('-5<i>t</i> = -10'));

  const stap4 = document.createElement('span');
  stap4.appendChild(htmlSpan('<i>t</i> = -10 <span class="markeer-lila">: (-5)</span>'));
  ...
  ll.appendChild(htmlSpan('-2 · <span class="markeer-lila">2</span> - 5 = -4 - 5 = -9'));

  const rl = document.createElement('span');
  const rl_b1 = maakSpanBreedte('0.65cm', 'RL:');
  rl.appendChild(rl_b1);
  rl.appendChild(htmlSpan('-15 + 3 · <span class="markeer-lila">2</span> = -15 + 6 = -9'));

  const inhoud = maakOefening({
    id:'oe_alles_4v4', nummer:'4', soort:'test',
    niveaus:[], tools:[],
