...
(function () {
  ...
  oe_10T005_1.appendChild(htmlSpan('Lees af hoeveel euro per dag de verwarming of airco kost bij een temperatuur van 10 °C.'));

  const oe_10T005_2 = document.createElement('span');
  oe_10T005_2.appendChild(htmlSpan('3 euro per dag'));
  ...
  oe_10T005_6.appendChild(htmlSpan('1 euro per dag'));

  const oe_10T005_7 = document.createElement('span');
  oe_10T005_7.appendChild(htmlSpan('Noteer bij welke temperaturen de kostprijs per dag 5,5 euro is.'));
  ...
  oe_10T005_9.appendChild(htmlSpan('In januari is de gemiddelde temperatuur ongeveer 0 °C. <br>Bereken hoeveel euro de verwarming die maand kost. (januari heeft 31 dagen)'));

  const oe_10T005_10 = document.createElement('span');
  oe_10T005_10.appendChild(htmlSpan('Bij 0 °C is de kostprijs 9 euro per dag.'));

  const oe_10T005_11 = document.createElement('span');
  oe_10T005_11.appendChild(htmlSpan('9 · 31 = 279 euro'));
  ...
  /* afbeelding1 */
  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_10T005.svg')
        .then(r => r.text())
        .then(svgTekst => {
