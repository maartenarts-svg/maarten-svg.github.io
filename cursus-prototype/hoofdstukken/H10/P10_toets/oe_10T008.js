...
(function () {
  ...
  oe_10T008_3.appendChild(htmlSpan('<i>s</i> = 6<i>n</i>'));

  const oe_10T008_4 = document.createElement('span');
  oe_10T008_4.appendChild(htmlSpan('Bereken het aantal stippen van de 30ste figuur.'));

  const oe_10T008_5 = document.createElement('span');
  oe_10T008_5.appendChild(htmlSpan('6 · <span class="markeer-lila">30</span> = 180'));
  ...
  const matrix = [
    ...
    [
      ...
      { inhoud: '18', type: 'toggle', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '24', type: 'toggle', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '30', type: 'toggle', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '', type: 'opgave', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '60', type: 'toggle', hAlign: 'center', vAlign: 'middle' },
    ],
  ];
...

  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_10T008.svg')
        .then(r => r.text())
        .then(svgTekst => {
