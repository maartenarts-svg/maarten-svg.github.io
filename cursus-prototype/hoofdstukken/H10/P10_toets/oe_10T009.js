...
(function () {
  ...
  oe_10T009_3.appendChild(htmlSpan('<i>s</i> = 4 + <i>n</i>'));

  const oe_10T009_4 = document.createElement('span');
  oe_10T009_4.appendChild(htmlSpan('Bereken het aantal stippen van de 30ste figuur.'));

  const oe_10T009_5 = document.createElement('span');
  oe_10T009_5.appendChild(htmlSpan('4 + <span class="markeer-lila">30</span> = 34'));
...

  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_10T009.svg')
        .then(r => r.text())
        .then(svgTekst => {
