...
(function () {
  ...
  oe_10T011_2.appendChild(htmlSpan('45 km'));

  const oe_10T011_3 = document.createElement('span');
  oe_10T011_3.appendChild(htmlSpan('Bereken de afstand die Remco gereden heeft na <br> 3,5 uur.'));

  const oe_10T011_4 = document.createElement('span');
  oe_10T011_4.appendChild(htmlSpan('18 · <span class="markeer-lila">3,5</span> = 63'));

  const oe_10T011_4b = document.createElement('span');
  oe_10T011_4b.appendChild(htmlSpan('Remco heeft dan 63 km gereden.'));  

  const oe_10T011_5 = document.createElement('span');
  oe_10T011_5.appendChild(htmlSpan('Wout is ook aan het fietsen. Bij hem wordt het verband tussen de afstand en de tijd weergegeven door de formule <i>d</i> = 14<i>t</i>. <br> Onderzoek wie na 3 uur de grootste afstand gereden heeft.<br>Bereken dat verschil.'));

  const oe_10T011_6 = document.createElement('span');
  oe_10T011_6.appendChild(htmlSpan('Remco: 18 · <span class="markeer-lila">3</span> = 54'));

  const oe_10T011_7 = document.createElement('span');
  oe_10T011_7.appendChild(htmlSpan('Wout: 14 · <span class="markeer-lila">3</span> = 42'));

  const oe_10T011_8 = document.createElement('span');
  oe_10T011_8.appendChild(htmlSpan('Remco heeft 54 km - 42 km = 12 km meer gereden.'));
...

  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_10T011.svg')
        .then(r => r.text())
        .then(svgTekst => {
