...
(function () {
  ...
  oe_10T010_2.appendChild(htmlSpan('22'));
  ...
  oe_10T010_5.appendChild(htmlSpan('<i>s</i> = 5<i>n</i> + 2'));

  const oe_10T010_6 = document.createElement('span');
  oe_10T010_6.appendChild(htmlSpan('Bereken het aantal stippen van de 75ste figuur.'));

  const oe_10T010_7 = document.createElement('span');
  oe_10T010_7.appendChild(htmlSpan('5 · <span class="markeer-lila">75</span> + 2 = 377'));
  ...
  const matrix = [
    ...
    [
      ...
      { inhoud: '22', type: 'toggle', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '27', type: 'toggle', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '', type: 'opgave', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '102', type: 'toggle', hAlign: 'center', vAlign: 'middle' },
    ],
  ];
...

  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_10T010.svg')
        .then(r => r.text())
        .then(svgTekst => {
