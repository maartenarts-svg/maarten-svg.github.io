...
(function () {
  ...
  const matrix = [
    ...
    [
      ...
      { inhoud: '300', type: 'opgave', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '400', type: 'opgave', hAlign: 'center', vAlign: 'middle' },
      { inhoud: '500', type: 'opgave', hAlign: 'center', vAlign: 'middle' },
    ],
  ];
  ...
  /* afbeelding1 */
  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_inhaal_10T006.svg')
        .then(r => r.text())
        .then(svgTekst => {
