...
(function () {
  ...
  /*====theoriekader===========================================*/
  {
    ...
    tdKort.appendChild(htmlSpan('som van termen met een verschillend letterdeel herleiden'));
    ...
    //begrip en opmerking
    {
      ...
      const th_102_begrA = htmlSpan('Om een som met termen met ');
      const th_102_begrA2 = htmlSpan('een verschillend letterdeel');
      th_102_begrA2.classList.add('theorie');
      th_102_begrA.appendChild(th_102_begrA2);
      th_102_begrA.appendChild(htmlSpan(' te herleiden:'));      
      ...
      txt.appendChild(htmlSpan('duid je de termen met eenzelfde letterdeel aan;'));       
      ...
      txt2.appendChild(htmlSpan('herleid je de som van de termen met eenzelfde letterdeel.'));
