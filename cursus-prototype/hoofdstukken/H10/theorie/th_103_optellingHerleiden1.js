...
(function () {
  ...
  /*====theoriekader===========================================*/
  {
    ...
    tdKort.appendChild(htmlSpan('som van termen met eenzelfde letterdeel herleiden'));
    ...
    //begrip en opmerking
    {
      ...
      const th_102_begrA2 = htmlSpan('eenzelfde letterdeel');
      ...
      txt.appendChild(htmlSpan('tel je de coëfficiënten op;'));       
      ...
      txt2.appendChild(htmlSpan('behoud je het letterdeel.'));
