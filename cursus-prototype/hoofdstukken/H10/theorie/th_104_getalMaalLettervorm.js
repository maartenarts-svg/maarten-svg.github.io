...
(function () {
  ...
  /*====theoriekader===========================================*/
  {
    ...
    tdKort.appendChild(htmlSpan('getal vermenigvuldigen met een lettervorm'));
    ...
    //begrip en opmerking
    {
      ...
      const th_102_begrA = htmlSpan('Om een getal te vermenigvuldigen met een lettervorm:');    
      ...
      txt.appendChild(htmlSpan('vermenigvuldig je dat getal met elke term van de lettervorm;'));       
      ...
      txt2.appendChild(htmlSpan('tel je de verkregen producten op.'));
      div04.appendChild(txt2);

      const div05 = document.createElement('div');
      div05.style.display = 'flex'; 
      maakSpanMetRuimte(div05,'0.3cm');
    ...
    }
    {
      ...
      const th_102_begrA = htmlSpan('Je past dus de ');
      const th_102_begrA2 = htmlSpan('distributieve eigenschap');
      th_102_begrA2.classList.add('theorie');
      th_102_begrA.appendChild(th_102_begrA2);
      th_102_begrA.appendChild(htmlSpan(' toe.'));      
      th_102_begrA.classList.add('theorietekst');
      div01.appendChild(th_102_begrA);
