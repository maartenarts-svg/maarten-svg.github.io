...
(function () {
  ...
  const inhoud = maakOefening({
    id:'oe_REM005', nummer:'?', soort:'test',
    niveaus:[], tools:[],
  ...
  /* Titel */
  {
    ...
    { const _v = 'Breuken delen'; if (typeof _v === 'string') _p.innerHTML = _v; else _p.appendChild(_v); }
  ...
  const _items = [
    ...
    'Ik kon de deling niet herschrijven als een vermenigvuldiging.',
    'Ik vermenigvuldigde de breuken verkeerd.',
