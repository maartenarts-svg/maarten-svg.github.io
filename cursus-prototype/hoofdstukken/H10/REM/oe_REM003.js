...
(function () {
  ...
  const inhoud = maakOefening({
    id:'oe_REM003', nummer:'?', soort:'test',
    niveaus:[], tools:[],
  ...
  /* Titel */
  {
    ...
    { const _v = 'Breuken optellen en aftrekken'; if (typeof _v === 'string') _p.innerHTML = _v; else _p.appendChild(_v); }
  ...
  const _items = [
    ...
    'Ik maakte de breuken niet eerst gelijknamig.',
    'Ik maakte een fout bij het gelijknamig maken.',
    'Ik deed de bewerking ook met de noemers.',
