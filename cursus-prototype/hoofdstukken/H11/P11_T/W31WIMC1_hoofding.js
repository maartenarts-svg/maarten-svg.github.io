...
(function () {
  ...
  const naamLeerling = ''; //→naam leelring
  const naamCoach = '';//→naam coach
  ...
  /*====hoofding===========================================*/
  {
    ...
    const tdNaam2 = maakSlTdZonderInsprong(naamLeerling,false);    
    ...
    const tdCoach2 = maakSlTdZonderInsprong(naamLeerling,false);     
    ...
    spanTitel.appendChild(htmlSpan('Toets rekenvaardigheden'));
