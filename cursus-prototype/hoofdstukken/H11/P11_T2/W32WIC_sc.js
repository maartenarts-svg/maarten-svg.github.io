...
(function () {
  ...
  const criteria = [
    ...
    },
    {
      ...
      scores: [
        { lbl: 'A:', tekst: 'Ik haal minstens 5 op 6.' },
        { lbl: 'B:', tekst: 'Ik haal minstens 3 op 6.' },
        { lbl: 'C:', tekst: 'Ik haal minder dan 3 op 6.' },
      ],
    },
    {
      nummer: '4|',
      ...
      scores: [
        { lbl: 'A:', tekst: 'Ik haal minstens 3 op 4.' },
        { lbl: 'B:', tekst: 'Ik haal minstens 2 op 4.' },
        { lbl: 'C:', tekst: 'Ik haal minder dan 2 op 4.' },
      ],
    },
    {
      nummer: '5|',
      ...
      scores: [
        { lbl: 'A:', tekst: 'Ik haal 2 op 2.' },
        { lbl: 'B:', tekst: 'Ik haal minstens 1 op 2.' },
        { lbl: 'C:', tekst: 'Ik haal minder dan 1 op 2.' },
      ],
    },
  ];
