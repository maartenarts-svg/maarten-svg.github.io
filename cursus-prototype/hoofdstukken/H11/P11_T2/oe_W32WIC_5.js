...
(function () {
  ...
  oe_W31WIE_5_1.appendChild(htmlSpan('2<i>x</i> + 3(4<i>x</i> - 5) - 6'));

  const oe_W31WIE_5_2 = document.createElement('span');
  oe_W31WIE_5_2.appendChild(htmlSpan('='));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('2<i>x</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('+ 12<i>x</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('- 15'), 'dubbel', '0.18cm', true));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('- 6'), 'dubbel', '0.18cm', true));

  const oe_W31WIE_5_3 = document.createElement('span');
  oe_W31WIE_5_3.appendChild(htmlSpan('= 14<i>x</i> - 21'));
  ...
  oe_W31WIE_5_4_s1.appendChild(htmlSpan('(-7<i>a</i> + 8) + '));
  oe_W31WIE_5_4_s1.appendChild(zetOmNaarOpl('1'));
  oe_W31WIE_5_4_s1.appendChild(htmlSpan('(9<i>a</i> - 10)'));
  ...
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('7<i>a</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('- 8'), 'dubbel', '0.18cm', true));
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('+ 9<i>a</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('- 10'), 'dubbel', '0.18cm', true));

  const oe_W31WIE_5_6 = document.createElement('span');
  oe_W31WIE_5_6.appendChild(htmlSpan('= 16<i>a</i> - 18'));
