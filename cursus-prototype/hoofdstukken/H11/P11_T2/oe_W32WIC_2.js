...
(function () {
  ...
  oe_W31WIE_2_1.appendChild(htmlSpan('7<i>a</i> - 3'));

  const oe_W31WIE_2_2 = document.createElement('span');
  oe_W31WIE_2_2.appendChild(htmlSpan('voor <i>x</i> = 5'));

  const oe_W31WIE_2_3 = document.createElement('span');
  oe_W31WIE_2_3.appendChild(htmlSpan('7 · <span class="markeer-lila">5</span> - 3'));

  const oe_W31WIE_2_4 = document.createElement('span');
  oe_W31WIE_2_4.appendChild(htmlSpan('= 35 - 3'));

  const oe_W31WIE_2_5 = document.createElement('span');
  oe_W31WIE_2_5.appendChild(htmlSpan('= 32'));

  const oe_W31WIE_2_6 = document.createElement('span');
  oe_W31WIE_2_6.appendChild(htmlSpan('4<i>y</i><sup>2</sup> - 2<i>y</i> + 8'));

  const oe_W31WIE_2_7 = document.createElement('span');
  oe_W31WIE_2_7.appendChild(htmlSpan('voor <i>y</i> = -1'));

  const oe_W31WIE_2_8 = document.createElement('span');
  oe_W31WIE_2_8.appendChild(htmlSpan('4 · <span class="markeer-lila">(-1)</span><sup>2</sup> - 2 · <span class="markeer-lila">(-1)</span> + 8'));

  const oe_W31WIE_2_9 = document.createElement('span');
  oe_W31WIE_2_9.appendChild(htmlSpan('= 4 · 1 - (-2) + 8'));

  const oe_W31WIE_2_10 = document.createElement('span');
  oe_W31WIE_2_10.appendChild(htmlSpan('= 4 + 2 + 8'));

  const oe_W31WIE_2_11 = document.createElement('span');
  oe_W31WIE_2_11.appendChild(htmlSpan('= 14'));  
