...
(function () {
  ...
  oe_111002_2.appendChild(htmlSpan('Voeg aan de kant van het blokje blauwe of oranje stippen toe, zodat er evenveel blauwe als oranje stippen zijn.'));
  oe_111002_2.appendChild(htmlSpan('<br>De balans is nu niet meer in evenwicht.'));

  const oe_111002_3 = document.createElement('span');
  oe_111002_3.appendChild(htmlSpan('Voeg aan de andere kant ook blauwe of oranje stippen toe, totdat de balans terug in evenwicht is.'));
  ...
  oe_111002_5.appendChild(htmlSpan('Elke blauwe stip “neutraliseert” een roze stip en omgekeerd, want  1 + (-1) = 0 = -1 + 1.'));
  oe_111002_5.appendChild(htmlSpan('<br>Klik op \'herleiden\' om alle overbodige stippen weg te halen.'));
  ...
  const inhoud = maakOefening({
    id:'oe_111002', nummer:'?', soort:'ontdek',
    niveaus:[], tools:[],
  ...
  const tdLblC = maakStap('3', oe_111002_3, false);
  ...
  const tdLblD = maakStap('4', oe_111002_4, false);
  ...
  const tdLblE = maakStap('5', oe_111002_5, false);
  ...
  const tdLblF = maakStap('6', oe_111002_6, false);
  ...
  oe_111002a_1.appendChild(htmlSpan('<i>x</i> + 8 = 3'));

  const oe_111002a_2 = document.createElement('span');
  oe_111002a_2.appendChild(htmlSpan('<i>x</i> + 8 <span class="markeer-lila">- 8</span> = 3 <span class="markeer-lila">- 8</span>'));

  const oe_111002a_3 = document.createElement('span');
  oe_111002a_3.appendChild(htmlSpan('<i>x</i> = -5'));

  const oe_111002a_4 = document.createElement('span');
  oe_111002a_4.appendChild(htmlSpan('-9 + <i>x</i> = -2'));

  const oe_111002a_5 = document.createElement('span');
  oe_111002a_5.appendChild(htmlSpan('<i>x</i> - 9 <span class="markeer-lila">+ 9</span> = -2 <span class="markeer-lila">+ 9</span>'));

  const oe_111002a_6 = document.createElement('span');
  oe_111002a_6.appendChild(htmlSpan('<i>x</i> = 7'));

  const oe_111002a_7 = document.createElement('span');
  oe_111002a_7.appendChild(htmlSpan('-7 = <i>x</i> - 3'));

  const oe_111002a_8 = document.createElement('span');
  oe_111002a_8.appendChild(htmlSpan('-7 <span class="markeer-lila">+ 3</span> = <i>x</i> -3 <span class="markeer-lila">+ 3</span>'));

  const oe_111002a_9 = document.createElement('span');
  oe_111002a_9.appendChild(htmlSpan('-4 = <i>x</i>'));

  const oe_111002a_10 = document.createElement('span');
  oe_111002a_10.appendChild(htmlSpan('6 = <i>x</i> + 5'));

  const oe_111002a_11 = document.createElement('span');
  oe_111002a_11.appendChild(htmlSpan('6 <span class="markeer-lila">- 5</span> = <i>x</i> + 5 <span class="markeer-lila">- 5</span>'));

  const oe_111002a_12 = document.createElement('span');
  oe_111002a_12.appendChild(htmlSpan('1 = <i>x</i>'));
