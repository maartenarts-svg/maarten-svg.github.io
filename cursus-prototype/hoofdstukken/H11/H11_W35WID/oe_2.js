...
(function () {
  ...
  oe_113011_1.appendChild(htmlSpan('Adam is 5 jaar ouder dan Bonnie.'));
  ...
  oe_113011_3.appendChild(htmlSpan('<i>l</i> + 5'));

  const oe_113011_4 = document.createElement('span');
  oe_113011_4.appendChild(htmlSpan('Van twee getallen is de som 10.'));
  ...
  oe_113011_6.appendChild(htmlSpan('10 - <i>g</i>'));

  const oe_113011_7 = document.createElement('span');
  oe_113011_7.appendChild(htmlSpan('Op een festival zijn 950 kinderen en volwassenen aanwezig.'));
  ...
  oe_113011_9.appendChild(htmlSpan('950 - <i>k</i>'));

  const oe_113011_13 = document.createElement('span');
  oe_113011_13.appendChild(htmlSpan('Audrey heeft 7 knikkers minder dan Babette en Mattie heeft er vier keer zoveel als Babette.'));
  ...
  const inhoud = maakOefening({
    id:'oe_113011', nummer:'?', soort:'test',
    niveaus:[''], tools:[],
  ...
  const tda0 = maakOpTdDubbelZStrZdub('',htmlSpan('leeftijd Bonnie:'),breedte1,false,oe_113011_2);
  ...
  const tda1 = maakOpTdDubbelZStrZdub('',htmlSpan('leeftijd Adam:'),breedte1,false,oe_113011_3);
  ...
  const tdLblE = maakOpTdaz('d', oe_113011_13, false);
  tdLblE.classList.add('kolom-links');
  trLblE.appendChild(tdLblE);
  tbody.appendChild(trLblE);

  const tre0 = document.createElement('tr');
  const tde0 = maakOpTdDubbelZStrZdub('',htmlSpan('aantal knikkers Babette:'),breedte1,false,oe_113011_14);
  ...
  const tde1 = maakOpTdDubbelZStrZdub('',htmlSpan('aantal knikkers Audrey:'),breedte1,false,oe_113011_15);
  tde1.classList.add('kolom-links');
  tre1.appendChild(tde1);
  tbody.appendChild(tre1);
  const tre2 = document.createElement('tr');
  const tde2 = maakOpTdDubbelZStrZdub('',htmlSpan('aantal knikkers Mattie:'),breedte1,false,oe_113011_16);
