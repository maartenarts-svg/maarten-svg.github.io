...
(function () {
  ...
  oe_W31WIE_5_1.appendChild(htmlSpan('3<i>a</i> + 4(2<i>a</i> - 8) - 5'));

  const oe_W31WIE_5_2 = document.createElement('span');
  oe_W31WIE_5_2.appendChild(htmlSpan('='));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('3<i>a</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('+ 8<i>a</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('- 32'), 'dubbel', '0.18cm', true));
  oe_W31WIE_5_2.appendChild(htmlSpan(' '));
  oe_W31WIE_5_2.appendChild(maakOnderstreping(htmlSpan('- 5'), 'dubbel', '0.18cm', true));

  const oe_W31WIE_5_3 = document.createElement('span');
  oe_W31WIE_5_3.appendChild(htmlSpan('= 11<i>a</i> - 37'));
  ...
  oe_W31WIE_5_4_s1.appendChild(htmlSpan('(-5<i>x</i> + 9) + '));
  oe_W31WIE_5_4_s1.appendChild(zetOmNaarOpl('1'));
  oe_W31WIE_5_4_s1.appendChild(htmlSpan('(3<i>x</i> - 7)'));
  ...
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('5<i>x</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('- 9'), 'dubbel', '0.18cm', true));
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('+ 3<i>x</i>'), 'enkel', '0.1cm', true));
  oe_W31WIE_5_5.appendChild(htmlSpan(' '));
  oe_W31WIE_5_5.appendChild(maakOnderstreping(htmlSpan('- 7'), 'dubbel', '0.18cm', true));

  const oe_W31WIE_5_6 = document.createElement('span');
  oe_W31WIE_5_6.appendChild(htmlSpan('= 8<i>x</i> - 16'));
