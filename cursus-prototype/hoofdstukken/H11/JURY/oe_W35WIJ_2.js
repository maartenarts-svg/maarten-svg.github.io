...
(function () {
  ...
  const oe_W35WIJ_2_2 = document.createElement('span');
  oe_W35WIJ_2_2.appendChild(htmlSpan('10<sup>4</sup>'));

  const oe_W35WIJ_2_3 = document.createElement('span');
  oe_W35WIJ_2_3.appendChild(htmlSpan('= 10 · 10 · 10 · 10'));

  const oe_W35WIJ_2_4 = document.createElement('span');
  oe_W35WIJ_2_4.appendChild(htmlSpan('= 10 000'));

  const oe_W35WIJ_2_5 = document.createElement('span');
  oe_W35WIJ_2_5.appendChild(htmlSpan('(-5)<sup>3</sup>'));

  const oe_W35WIJ_2_6 = document.createElement('span');
  oe_W35WIJ_2_6.appendChild(htmlSpan('= -5 · (-5) · (-5)'));

  const oe_W35WIJ_2_7 = document.createElement('span');
  oe_W35WIJ_2_7.appendChild(htmlSpan('= -125'));

  const oe_W35WIJ_2_8 = document.createElement('span');
  oe_W35WIJ_2_8.appendChild(htmlSpan('Noteer het teken van het eindresultaat: + (positief) of - (negatief).'));

  const oe_W35WIJ_2_9 = document.createElement('span');
  oe_W35WIJ_2_9.appendChild(htmlSpan('-(-25)<sup>38</sup>'));

  const oe_W35WIJ_2_10 = document.createElement('span');
  oe_W35WIJ_2_10.appendChild(htmlSpan('-'));

  const oe_W35WIJ_2_11 = document.createElement('span');
  oe_W35WIJ_2_11.appendChild(htmlSpan('-108<sup>16</sup>'));

  const oe_W35WIJ_2_12 = document.createElement('span');
  oe_W35WIJ_2_12.appendChild(htmlSpan('-'));

  const inhoud = maakOefening({
    id:'oe_W35WIJ_2', nummer:'?', soort:'test',
    niveaus:[], tools:[],
  ...
  /* ---- Opgave a ---- */
  {
    ...
    const td = maakOpTdaz('a', oe_W35WIJ_2_1, false);
  ...
  /* hulptabel voor subopgaven */
  {
    ...
    /* rij 1 — labels */
    {
      ...
      const tdLblL = maakOpTdaz('1', oe_W35WIJ_2_2, false);
      tdLblL.classList.add('kolom-links');
      trL.appendChild(tdLblL);
      const tdLblR = maakOpTdaz('2', oe_W35WIJ_2_5, false);
  ...
  {
    const tr = document.createElement('tr');
    const td = maakOpTdaz('b', oe_W35WIJ_2_8, false);
    td.classList.add('kolom-links');
    tr.appendChild(td);
    tbody.appendChild(tr);
  }
  ...
  /* hulptabel voor subopgaven */
  {
    ...
    {
      const tr = document.createElement('tr');
      const tdL = maakOpTdDubbelZStrZdub('1|', oe_W35WIJ_2_9, TW, false, oe_W35WIJ_2_10);
      tdL.classList.add('kolom-links');
      tr.appendChild(tdL);
      const tdR = maakOpTdDubbelZStrZdub('2|', oe_W35WIJ_2_11, TW, false, oe_W35WIJ_2_12);
