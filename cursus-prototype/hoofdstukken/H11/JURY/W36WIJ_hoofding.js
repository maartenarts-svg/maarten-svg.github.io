...
(function () {
  ...
  /*====hoofding===========================================*/
  {
    ...
    const col1 = document.createElement('col'); col1.style.width = '22%'; colg.appendChild(col1);
    const col2 = document.createElement('col'); col2.style.width = '78%'; colg.appendChild(col2);
    ...
    const trLeerling = document.createElement('tr');
    const tdLeerling = document.createElement('td');
    tdLeerling.style.height = '0.9cm';
    tdLeerling.style.textAlign = 'left';
    tdLeerling.style.verticalAlign = 'middle';
    tdLeerling.appendChild(htmlSpan('Evaluatie voor:'));
    trLeerling.appendChild(tdLeerling);
    const tdLeerling2 = document.createElement('td');    
    tdLeerling2.style.height = '0.9cm';
    tdLeerling2.style.textAlign = 'left';
    tdLeerling2.style.verticalAlign = 'middle';
    tdLeerling2.appendChild(htmlSpan('_______________________________________________________________'));
    tdLeerling2.style.overflow = 'hidden';
    tdLeerling2.classList.add('sl');
    trLeerling.appendChild(tdLeerling2); 
    tbodyMidden.appendChild(trLeerling);  
    ...
    spanTitel.appendChild(htmlSpan('Voorbereiding jury deel 2'));
...

    {
      ...
      tdTaak.style.textAlign = 'left';
      tdTaak.style.verticalAlign = 'middle';
      tdTaak.appendChild(htmlSpan('Markeer:'));
      trTaak.appendChild(tdTaak);
      const tdTaak2 = document.createElement('td');    
      tdTaak2.style.height = '0.9cm';
      tdTaak2.style.textAlign = 'left';
      ...
      const spanTitel = document.createElement("span");
      spanTitel.appendChild(htmlSpan('Fien / Maarten'));
      spanTitel.style.width = '75%';
      spanTitel.style.textAlign = 'left';
      divTitel.appendChild(spanTitel); 
      const spanWerktijdTitel = document.createElement("span");
      spanWerktijdTitel.appendChild(htmlSpan(''));
      spanWerktijdTitel.style.width = '15%';
      spanWerktijdTitel.style.textAlign = 'left';
      divTitel.appendChild(spanWerktijdTitel);
      const spanWerktijd = document.createElement("span");
      spanWerktijd.appendChild(htmlSpan(""));
      spanWerktijd.style.width = '10%';
      spanWerktijd.style.textAlign = 'left';
      divTitel.appendChild(spanWerktijd);
