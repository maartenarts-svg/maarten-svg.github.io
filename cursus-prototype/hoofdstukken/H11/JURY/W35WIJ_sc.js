...
(function () {
  ...
  const criteria = [
    {
      nummer: '1|',
      tekst:  'Bestudeer de oefeningen.',
      scores: [
      ],
    },
    {
      nummer: '2|',
      tekst:  'Noteer bij elke oefening het nummer van het succescriterium dat volgens jou met die vraag getoetst wordt.',
      scores: [
        { lbl: '•', tekst: 'De succescriteria kun je terugvinden op de projectsite, bij Wiskunde 1A week 6, jury.' },
        { lbl: '•', tekst: 'Bij één oefening kan meer dan één succescriteria horen.' },
        { lbl: '•', tekst: 'Een succescriterium kan bij meer dan één oefening horen.' },
      ],
    },
    {
      nummer: '3|',
    ...
    {
      nummer: '4|',
      tekst:  'Maak de oefeningen.',
      scores: [
        { lbl: '•', tekst: 'Moet je de rekenregels opzoeken of theorie bekijken? Noteer het bladzijdenummer bij de oefening.' },
      ],
    },
    {
      nummer: '5|',
      tekst:  'Vergelijk jouw oplossingen met die van iemand anders. ',
      scores: [
        { lbl: '•', tekst: 'Leg uit aan elkaar hoe je de oefening opgelost hebt.' },
        { lbl: '•', tekst: 'Verschillende werkwijze? Zoek op in de theorie.' },
      ],
    },
  ];
