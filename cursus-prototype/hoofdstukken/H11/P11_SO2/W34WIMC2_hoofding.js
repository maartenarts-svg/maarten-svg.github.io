...
(function () {
  ...
  /*====hoofding===========================================*/
  {
    ...
    h01.appendChild(maakSpanBreedte('8.5cm',''));
    h01.appendChild(htmlSpan('$$naam$$'));
    const tdNaam2 = maakSlTdZonderInsprong(h01,false);
    tdNaam2.querySelector('.opl')?.classList.add('zichtbaar');
    tdNaam2.classList.add('voorgedrukt');
    ...
    const tdCoach2 = maakSlTdZonderInsprong(htmlSpan(''),false);    
    ...
    spanTitel.appendChild(htmlSpan('Statistisch onderzoek'));
    ...
    const spanCoach = htmlSpan('coach');
