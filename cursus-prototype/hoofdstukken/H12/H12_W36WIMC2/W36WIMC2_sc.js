/* ============================================================
   H12 / H12_W36WIMC2 / W36WIMC2_sc.js
...
(function () {
  ...
  const criteria = [
    {
      nummer: '1|',
      tekst:  'Ik maak een onderscheid tussen omtrek en oppervlakte. (vraag 1, 6.8)',
      scores: [
    ...
    {
      nummer: '2|',
      tekst:  'Ik bereken de omtrek en de oppervlakte van een rechthoek en een vierkant. (vraag 2, 6.4)',
      scores: [
        { lbl: 'A:', tekst: 'Ik kan dit.' },
        { lbl: 'B:', tekst: 'Ik kan dit, maar maak nog rekenfouten.' },
        { lbl: 'C:', tekst: 'Ik kan dit nog niet.' },
      ],
    },
    {
      nummer: '3|',
      tekst:  'Ik los problemen op in verband met omtrek en oppervlakte. (vraag 3, 6.22)',
      scores: [
        { lbl: 'A:', tekst: 'Ik kan dit.' },
        { lbl: 'B:', tekst: 'Mijn werkwijze is duidelijk en klopt, maar de uitwerking is niet helemaal juist.' },
        { lbl: 'C:', tekst: 'Ik kan dit nog niet.' },
      ],
    },
    {
      nummer: '4|',
      tekst:  'Ik bereken de omtrek en de oppervlakte van samengestelde figuren. (vraag 4, V6.7)',
      scores: [
        { lbl: 'A:', tekst: 'Ik kan dit.' },
        { lbl: 'B:', tekst: 'Mijn werkwijze is duidelijk en klopt, maar de uitwerking is niet helemaal juist.' },
        { lbl: 'C:', tekst: 'Ik kan dit nog niet.' },
