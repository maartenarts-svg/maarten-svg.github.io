...
(function () {
  ...
  const oe_122004_2 = document.createElement('span');
  const oe_122004_2_b1 = maakSpanBreedte('0.4cm', '•');
  oe_122004_2.appendChild(oe_122004_2_b1);
  const oe_122004_2_b2 = maakSpanBreedte('1cm', 'Plan:');
  oe_122004_2.appendChild(oe_122004_2_b2);
  oe_122004_2.appendChild(htmlSpan('De figuur telt 8 bogen. Elke boog is een kwart van'));

  const oe_122004_3 = document.createElement('span');
  const oe_122004_3_b1 = maakSpanBreedte('1.4cm', '');
  oe_122004_3.appendChild(oe_122004_3_b1);
  oe_122004_3.appendChild(htmlSpan('een cirkel met straal 1.'));

  const oe_122004_4 = document.createElement('span');
  const oe_122004_4_b1 = maakSpanBreedte('1.4cm', '');
  oe_122004_4.appendChild(oe_122004_4_b1);
  oe_122004_4.appendChild(htmlSpan('De lengte van alle bogen samen is dus de omtrek'));

  const oe_122004_5 = document.createElement('span');
  const oe_122004_5_b1 = maakSpanBreedte('1.4cm', '');
  oe_122004_5.appendChild(oe_122004_5_b1);
  oe_122004_5.appendChild(htmlSpan('van 2 cirkels.'));

  const oe_122004_7 = document.createElement('span');
  const oe_122004_7_b1 = maakSpanBreedte('0.4cm', '•');
  oe_122004_7.appendChild(oe_122004_7_b1);
  const oe_122004_7_b2 = maakSpanBreedte('2.5cm', 'Berekening:');
  oe_122004_7.appendChild(oe_122004_7_b2);
  const oe_122004_7_b3 = maakSpanBreedte('2cm', '- 1 cirkel:');
  oe_122004_7.appendChild(oe_122004_7_b3);
  oe_122004_7.appendChild(htmlSpan('2 · π · 1 = 2π'));

  const oe_122004_8 = document.createElement('span');
  const oe_122004_8_b1 = maakSpanBreedte('2.9cm', '');
  oe_122004_8.appendChild(oe_122004_8_b1);
  const oe_122004_8_b2 = maakSpanBreedte('2cm', '- 2 cirkels:');
  oe_122004_8.appendChild(oe_122004_8_b2);
  oe_122004_8.appendChild(htmlSpan('2 · 2π ≈ 12,57'));

  const oe_122004_9 = document.createElement('span');
  const oe_122004_9_b1 = maakSpanBreedte('0.4cm', '•');
  oe_122004_9.appendChild(oe_122004_9_b1);
  oe_122004_9.appendChild(htmlSpan('Antwoord: De omtrek is 12,57.'));

  const inhoud = maakOefening({
    id:'oe_122004', nummer:'?', soort:'inoefenen',
    niveaus:[], tools:[],
  ...
  /* Introductietekst */
  {
    ...
    { const _v='De figuur is opgebouwd uit cirkelbogen van een cirkel met straal 1.<br>Bereken de omtrek van de figuur.'; if(typeof _v==='string') _p.innerHTML=_v; else _p.appendChild(_v); }
  ...
  /* Schrijflijn 1 van 1 */
  {
    ...
    const _td_0_0 = maakSlTdZonderInsprong(oe_122004_2, false);
  ...
  /* Schrijflijn 2 van 1 */
  {
    ...
    const _td_0_1 = maakSlTdZonderInsprong(oe_122004_3, false);
  ...
  /* Schrijflijn 3 van 1 */
  {
    ...
    const _td_0_2 = maakSlTdZonderInsprong(oe_122004_4, false);
  ...
  /* Schrijflijn 4 van 1 */
  {
    ...
    const _td_0_3 = maakSlTdZonderInsprong(oe_122004_5, false);
  ...
  /* Schrijflijn 6 van 1 */
  {
    ...
    const _td_0_5 = maakSlTdZonderInsprong(oe_122004_7, false);
  ...
  /* Schrijflijn 7 van 1 */
  {
    ...
    const _td_0_6 = maakSlTdZonderInsprong(oe_122004_8, false);
  ...
  /* Schrijflijn 8 van 1 */
  {
    ...
    const _td_0_7 = maakSlTdZonderInsprong(oe_122004_9, false);
  ...
  /* afbeelding1 */
  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_122004.svg') /* ← bestandsnaam */
        .then(r => r.text())
        .then(svgTekst => {
          ...
          const oplLagen = ['layer3']; /* ← oplossingenlagen */
          oplLagen.forEach(id => {
