...
(function () {
  ...
  opl_a_formule.appendChild(htmlSpan('<i>P</i> = 4<i>z</i>'));

  const opl_a_berek = document.createElement('span');
  opl_a_berek.appendChild(htmlSpan('4 · 3 = 12'));

  const opl_b_formule = document.createElement('span');
  opl_b_formule.appendChild(htmlSpan('<i>A</i> = <i>z</i><sup>2</sup>'));

  const opl_b_berek = document.createElement('span');
  opl_b_berek.appendChild(htmlSpan('3<sup>2</sup> = 9'));
  ...
  voegRij(maakOpTdDubbelZStrZdub('•', maakBerekenLabel('mm'), '4cm', false, opl_a_berek), true);
  voegRij(maakAntwoordTd('De omtrek is', '12 mm.'), true);
  ...
  voegRij(maakOpTdDubbelZStrZdub('•', maakBerekenLabel('mm<sup>2</sup>'), '4cm', false, opl_b_berek), true);
  voegRij(maakAntwoordTd('De oppervlakte is', '9 mm<sup>2</sup>.'), true);
...

  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_36D001.svg')
        .then(r => r.text())
        .then(svgTekst => {
