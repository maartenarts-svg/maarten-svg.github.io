...
(function () {
  ...
  opl_a_berek.appendChild(htmlSpan('5 + 6 + 5 + 6 = 22'));
  ...
  voegRij(maakOpTdDubbelZStrZdub('•', maakBerekenLabel('m'), '4cm', false, opl_a_berek), true);
  voegRij(maakAntwoordTd('De omtrek is', '22 m.'), true);
  ...
  voegRij(maakOpTdDubbelZStrZdub('•', maakBerekenLabel('m<sup>2</sup>'), '4cm', false, opl_b_berek), true);
  voegRij(maakAntwoordTd('De oppervlakte is', '24 m<sup>2</sup>.'), true);
...

  {
    ...
    requestAnimationFrame(() => {
      ...
      fetch('afbeeldingen/oe_36D004.svg')
        .then(r => r.text())
        .then(svgTekst => {
