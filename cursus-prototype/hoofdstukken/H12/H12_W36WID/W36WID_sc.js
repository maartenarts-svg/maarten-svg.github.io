...
(function () {
  ...
  const criteria = [
    {
      nummer: '1|',
      tekst:  'Ik ken de formules voor de omtrek van een vierkant, een rechthoek, een ruit, een cirkel en voor de omtrek van andere vierhoeken. (6.8)',
      scores: [
    ...
    {
      nummer: '2|',
      tekst:  'Ik ken de formules voor de oppervlakte van een vierkant, een rechthoek, een parallellogram, een cirkel en een driehoek. (6.8)',
      scores: [
        { lbl: 'A:', tekst: 'Ik ken ze allemaal.' },
        { lbl: 'B:', tekst: 'Ik ken ze bijna allemaal.' },
        { lbl: 'C:', tekst: 'Ik ken er nog te weinig om goed de oefeningen te kunnen maken.' },
    ...
    {
      nummer: '3|',
      tekst:  'Ik bereken de omtrek en de oppervlakte van een rechthoek en een vierkant. (6.8)',
      scores: [
        { lbl: 'A:', tekst: 'Ik doe dit bijna foutloos.' },
        { lbl: 'B:', tekst: 'Ik kan dit, maar maak veel rekenfouten of fouten bij eenheden.' },
        { lbl: 'C:', tekst: 'Ik kan dit nog niet.' },
      ],
    },
    {
      nummer: '4|',
      tekst:  'Ik bereken de omtrek van een figuur met behulp van een formule. (6.8)',
      scores: [
        { lbl: 'A:', tekst: 'Ik doe dit bijna foutloos.' },
        { lbl: 'B:', tekst: 'Ik kan dit, maar maak veel rekenfouten of fouten bij eenheden.' },
        { lbl: 'C:', tekst: 'Ik kan dit nog niet.' },
    ...
    {
      nummer: '5|',
      tekst:  'Ik bereken de oppervlakte van een figuur met behulp van een formule. (6.8)',
      scores: [
        { lbl: 'A:', tekst: 'Ik doe dit bijna foutloos.' },
        { lbl: 'B:', tekst: 'Ik kan dit, maar maak veel rekenfouten of fouten bij eenheden.' },
        { lbl: 'C:', tekst: 'Ik kan dit nog niet.' },
