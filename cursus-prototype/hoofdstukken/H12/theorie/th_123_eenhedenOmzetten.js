/* ============================================================
   H12 / th_123_eenhedenOmzetten.js
   ============================================================ */
(function () {
  ...
  /*====theoriekader===========================================*/
  {
    ...
    tdKort.appendChild(htmlSpan('Oppervlakte-eenheden omzetten'));
    ...
    // --- Werkwijze ---
    {
      ...
      span.appendChild(htmlSpan('Wil je een oppervlakte omzetten in een andere eenheid,'));
    ...
    // Sub-bullet: één trap naar boven
    {
      ...
      lbl.classList.add('lbl');
      rij.appendChild(lbl);
      const tekst = htmlSpan('één stap naar boven is 100 keer groter, twee naar boven is 100<sup>2</sup> keer groter, 3 naar boven is 100<sup>3</sup> keer groter ...;');
    ...
    // Sub-bullet: één trap naar onder
    {
      ...
      lbl.classList.add('lbl');
      rij.appendChild(lbl);
      const tekst = htmlSpan('één stap naar onder is 100 keer kleiner, twee naar onder is 100<sup>2</sup> keer kleiner, 3 naar onder is 100<sup>3</sup> keer kleiner ...');
      tekst.classList.add('theorietekst');
      tekst.style.fontSize = '0.85em';
      tekst.style.flex = '1';
      tekst.style.minWidth = '0';
