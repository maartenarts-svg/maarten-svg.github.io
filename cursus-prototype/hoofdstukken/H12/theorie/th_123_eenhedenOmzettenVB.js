/* ============================================================
   H12 / th_123_eenhedenOmzettenVB.js
   ============================================================ */
(function () {
  ...
  const xEenheid2    = 180;  // tweede eenheid
  ...
  /*====voorbeeldkader=========================================*/
  {
    ...
    td2.appendChild(maakOmzetVoorbeeld(
      '0,005 24', 'm²', '5 240', 'mm²',
      'de eenheid wordt 100³ keer kleiner',
      'het maatgetal wordt 100³ keer groter',
      'pijl-vb4'
    ));
    ...
    td4.style.paddingTop = '0.1cm';
    {
      const span = document.createElement('span');
      span.classList.add('theorietekst');
      span.innerHTML = 'In plaats van te vermenigvuldigen met 100<sup>3</sup>, kun je ook 3 keer vermenigvuldigen met 100.<br>'
                     + '0,005 24 · 100 = 0,524<br>'
                     + '0,524 · 100 = 52,4<br>'
                     + '52,4 · 100 = 5 240<br>';
