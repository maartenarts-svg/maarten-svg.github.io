...
(function () {
  ...
  /*====theoriekader===========================================*/
  {
    ...
    tdKort.appendChild(htmlSpan('een term wegwerken in een lid van een vergelijking'));
    ...
    //eerste zin
    {
      ...
      th_102_begrA.appendChild(htmlSpan('Om in een vergelijking een term weg te werken:'));
    ...
    }
    {
      ...
      th_102_begrA.appendChild(htmlSpan('vermeerder of verminder je beide leden met een gepaste term;'));
